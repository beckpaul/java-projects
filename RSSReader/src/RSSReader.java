...
public final class RSSReader {
     ...
     */
    private static XMLTree getRSSChannel(SimpleReader in, SimpleWriter out) {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        int channelTitleIndex = getChildElement(channel, "title"),
                ...
                channelDescriptionIndex = getChildElement(channel,
                        "description");
        // Trying to make this well formed HTML makes this borderline unreadable
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        out.print("    <td>");
        if (itemTitleIndex != -1 && itemLinkIndex != -1) {
            out.print("<a href=\"" + item.child(itemLinkIndex).child(0) + "\">"
                    + item.child(itemTitleIndex).child(0) + "</a>");
        } else if (itemTitleIndex == -1) {
            out.print("<a href=\"" + item.child(itemLinkIndex).child(0)
                    + "\"> No Description found. </a>");
        } else if (itemLinkIndex == -1) {
    ...
    public static void main(String[] args) {
        ...
        out.print(
                "Please enter a file name to be used including the .html extension: ");
