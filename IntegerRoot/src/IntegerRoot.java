...
public final class IntegerRoot {
    ...
    private static int root(int n, int r) {
        ...
        assert r > 0 : "violation of r > 0";
        Integer lower, upper, guess;
        //Set upper and lower
        upper = n + 1;
        lower = 0;
        // Initial guess
        ...
        while (upper - lower > 1) {
            // Guess the floor of the midpoint of the interval as
            guess = (lower + upper) / 2;
            //asking whether n1/r < g
            if ((power(guess, r)) > n) {
                upper = guess;
            } else {
                lower = guess;
    ...
    public static void main(String[] args) {
        ...
        out.println(numbers.length + " Tests, " + count + " tests ran");
        out.close();
    }
