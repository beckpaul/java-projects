...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    /**
     * Added to get check style to stop complaining.
     */
    ...
    public NNCalcView1() {
        ...
        // Create and set all 9 operand buttons
        ...
        // Disable divide and root as initial state
        ...
        JPanel primaryButtonPanel = new JPanel(new GridLayout(
        ...
        // Add 7-9 and addition button
        for (int i = 7; i <= DIGIT_BUTTONS - 1; i++) {
            primaryButtonPanel.add(this.bDigits[i]);
        }
        primaryButtonPanel.add(this.bAdd);
        // Add 4-6 and subtraction button
        for (int i = 4; i <= 6; i++) {
            primaryButtonPanel.add(this.bDigits[i]);
        }
        // Add 1-3 and multiply
        primaryButtonPanel.add(this.bSubtract);
        for (int i = 1; i <= 3; i++) {
            primaryButtonPanel.add(this.bDigits[i]);
        }
        // Add remaining buttons
        primaryButtonPanel.add(this.bMultiply);
        primaryButtonPanel.add(this.bDigits[0]);
        primaryButtonPanel.add(this.bPower);
        primaryButtonPanel.add(this.bRoot);
        primaryButtonPanel.add(this.bDivide);

        // Create combined button panel organized using flow layout
        JPanel combinedPanel = new JPanel(new FlowLayout());

        //Add the other two button panels to the combined button panel
        combinedPanel.add(primaryButtonPanel);
